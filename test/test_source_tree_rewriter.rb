...
(rewriter):1:6: error: insertions are crossing
...
(rewriter):1:6: warning: deletions are crossing
(rewriter):1: puts(:hello, :world)
(rewriter):1:      ^~~~~~~~~~~~~~
DIAGNOSTIC
  end
...
(rewriter):1:6: warning: replacement on would swallow some inner rewrites
(rewriter):1: puts(:hello, :world)
(rewriter):1:       ~~~~~
DIAGNOSTIC
  end
